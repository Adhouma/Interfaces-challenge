...
public class Main {
	...
	public static void main(String[] args) {
		...
		Person person = new Person("Abdeladhim", 10, 100);
		person.toString();
		saveObject(person);
		loadObject(person);
	...
	public static void loadObject(Saveable objectToLoad) {
		...
		List<String> loadedObject = objectToLoad.read(values);
		for(int i = 0; i < loadedObject.size(); i++) {
			System.out.println("Load " + loadedObject.get(i) + " from the storage device ...");
		}
	}
